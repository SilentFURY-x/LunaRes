...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      ref={buttonRef}
      onClick={toggleTheme}
      className={cn("p-2 rounded-md hover:bg-glassBase transition-colors", className)}
      {...props}
    >
      {isDark ? <Sun className="w-5 h-5 text-primaryText" /> : <Moon className="w-5 h-5 text-primaryText" />}
